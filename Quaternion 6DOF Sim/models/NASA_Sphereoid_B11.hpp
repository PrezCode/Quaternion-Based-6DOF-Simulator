//NASA Spheroid for atmospheric check cases; NESC-RP-12-00770, V1.0
#pragma once
#include <iostream>
#include <cmath>
#include <array>
...
class Sphere{
    public:
    Sphere(){
        modelData[0] = I[x][x] = 3.6*slugftsq2kgmsq;
        modelData[1] = I[y][y] = 3.6*slugftsq2kgmsq;
        modelData[2] = I[z][z] = 3.6*slugftsq2kgmsq;
        modelData[3] = I[x][y] = 0.0;
        modelData[4] = I[y][z] = 0.0;
        modelData[5] = I[z][x] = 0.0;        
        modelData[6] = mass = 1.0*slug2kg;
        modelData[7] = cgOffset[x] = 0.0;
        modelData[8] = cgOffset[y] = 0.0;
        modelData[9] = cgOffset[z] = 0.0;
        modelData[10] = Aref = 0.1963495*sqft2sqm;
    ...
    I[3][3]{0.0}, mass{0.0}, xbar{0.0}, ybar{0.0}, zbar{0.0}, Aref{0.0}, span{0.0}, chord{0.0}, cgOffset[3]{0.0}, length_body{0.0}, length_nose{0.0}, diameter{0.0},
