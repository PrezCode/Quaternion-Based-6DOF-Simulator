...
public:
  Sphere(){
    m_modelData[0] = m_I[x][x] = Units::SlugFtSqToKgMSq(3.6);
    m_modelData[1] = m_I[y][y] = Units::SlugFtSqToKgMSq(3.6);
    m_modelData[2] = m_I[z][z] = Units::SlugFtSqToKgMSq(3.6);
    m_modelData[3] = m_I[x][y] = 0.0;
    m_modelData[4] = m_I[y][z] = 0.0;
    m_modelData[5] = m_I[z][x] = 0.0;
    m_modelData[6] = m_mass = Units::SlugsToKg(1.0);
    m_modelData[7] = m_cgOffset[x] = 0.0;
    m_modelData[8] = m_cgOffset[y] = 0.0;
    m_modelData[9] = m_cgOffset[z] = 0.0;
    m_modelData[10] = m_Aref = Units::SqFeetToSqMeters(0.1963495);
